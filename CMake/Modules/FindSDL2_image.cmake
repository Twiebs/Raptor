...
if (SDLIMAGE_INCLUDE_DIR)
  set (SDL2_IMAGE_FOUND 1 CACHE STRING "Set to 1 if SDL_image is found, 0 otherwise")
else (SDL2_IMAGE_INCLUDE_DIR)
  set (SDL2_IMAGE_FOUND 0 CACHE STRING "Set to 1 if SDL_image is found, 0 otherwise")
endif (SDL2_IMAGE_INCLUDE_DIR)

mark_as_advanced (SDL2_IMAGE_FOUND)
