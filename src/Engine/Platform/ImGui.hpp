...
static void ImGUIRenderDrawLists(ImDrawList** const drawList, int drawListCount) {
	...
	ImGuiContext* imGuiContext = (ImGuiContext*)ImGui::GetIO().UserData;
...
bool ImGuiContextInit(ImGuiContext* imGuiContext) {
    ...
    imGuiContext->samplerUniformLoc = glGetUniformLocation(imGuiContext->shaderProgramID, "sampler");
    imGuiContext->projectionUniformLoc = glGetUniformLocation(imGuiContext->shaderProgramID, "projection");
