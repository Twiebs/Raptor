...
Raptor::DebugModelData global_pillar;
...
int main()
{
	...
	Shader shaderGeometryPass("../src/Tests/DeferredTest/g_buffer.vs", "../src/Tests/DeferredTest/g_buffer.frag");
	Shader shaderLightingPass("../src/Tests/DeferredTest/deferred_shading.vs", "../src/Tests/DeferredTest/deferred_shading.frag");
	Shader shaderLightBox("../src/Tests/DeferredTest/deferred_light_box.vs", "../src/Tests/DeferredTest/deferred_light_box.frag");
	...
	// Models
	global_pillar.LoadFromFile("models/Pillars/pillar/pillar.obj");
	//global_pillar.LoadFromFile("models/nanosuit/nanosuit.obj");
	//global_pillar.LoadFromFile("models/Lara/Lara_Croft_default.obj");



#if 0
	Model cyborg("../Assets/models/nanosuit/nanosuit.obj");
#endif
